    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          className,
          isMobile &&
            "top-auto bottom-[var(--app-bottom-inset)] left-0 right-0 max-h-[var(--app-sheet-max)] max-w-none translate-x-0 translate-y-0 gap-0 overflow-hidden rounded-t-3xl rounded-b-none p-0 pb-[max(0.75rem,var(--safe-bottom))] shadow-2xl data-open:zoom-in-100"
        )}
        {...props}
      >
        {isMobile ? (
