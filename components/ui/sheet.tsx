    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          resolvedSide === "bottom" &&
            isMobile &&
            "h-[var(--app-sheet-max)] max-h-[var(--app-sheet-max)] gap-0 overflow-hidden rounded-t-3xl border-x-0 pb-[max(0.5rem,var(--safe-bottom))] data-[side=bottom]:bottom-[var(--app-bottom-inset)]",
          className
        )}
        {...props}
      >
